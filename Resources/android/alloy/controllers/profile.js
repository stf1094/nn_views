...
function Controller() {
    ...
    $.__views.contactInfo.add($.__views.__alloyId221);
    ...
    $.__views.__alloyId221.add($.__views.__alloyId228);
    ...
    $.__views.__alloyId221.add($.__views.__alloyId230);
    ...
    $.__views.__alloyId232 = Ti.UI.createTextField({
        width: "70%",
        height: "175px",
        borderRadius: "10",
        borderColor: "#ececec",
    ...
    $.__views.__alloyId233 = Ti.UI.createButton({
        left: 10,
        font: {
            fontSize: 30
        },
    ...
    $.__views.__alloyId235.add($.__views.profileImage);
    ...
    $.__views.__alloyId235.add($.__views.name);
    ...
    $.__views.__alloyId235.add($.__views.job);
    ...
    $.__views.__alloyId235.add($.__views.company);
    ...
    $.__views.__alloyId235.add($.__views.addFavoriteBtn);
    ...
    $.__views.__alloyId236.add($.__views.callBtn);
    $.__views.emailBtn = Ti.UI.createLabel({
        id: "emailBtn"
    });
    $.__views.__alloyId236.add($.__views.emailBtn);
    $.__views.msgBtn = Ti.UI.createLabel({
        id: "msgBtn"
    });
    $.__views.__alloyId236.add($.__views.msgBtn);
    ...
    $.__views.__alloyId237.add($.__views.fbBtn);
    $.__views.liBtn = Ti.UI.createLabel({
        id: "liBtn"
    });
    $.__views.__alloyId237.add($.__views.liBtn);
    $.__views.googBtn = Ti.UI.createLabel({
        id: "googBtn"
    });
    $.__views.__alloyId237.add($.__views.googBtn);
    ...
    $.__views.__alloyId240.add($.__views.start_date);
    ...
    $.__views.__alloyId239.add($.__views.__alloyId243);
    ...
    $.__views.__alloyId239.add($.__views.__alloyId246);
    ...
    $.__views.__alloyId239.add($.__views.__alloyId249);
    ...
    $.__views.__alloyId239.add($.__views.__alloyId253);
