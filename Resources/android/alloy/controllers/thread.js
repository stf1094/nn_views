...
function Controller() {
    ...
    $.__views.thread.add($.__views.__alloyId387);
    $.__views.__alloyId388 = Ti.UI.createScrollView({
        layout: "vertical",
        top: 0,
        height: 520,
        id: "__alloyId388"
    ...
    $.__views.__alloyId388.add($.__views.__alloyId393);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId394);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId395);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId396);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId397);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId398);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId399);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId400);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId401);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId402);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId403);
    ...
    $.__views.__alloyId388.add($.__views.__alloyId404);
    ...
    $.__views.__alloyId387.add($.__views.__alloyId405);
    $.__views.__alloyId406 = Ti.UI.createTextField({
        left: 10,
        width: "70%",
        height: "90px",
        borderRadius: "10",
    ...
    $.__views.__alloyId407 = Ti.UI.createButton({
        left: 10,
        font: {
            fontSize: 30
        },
