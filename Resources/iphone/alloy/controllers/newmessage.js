...
function Controller() {
    ...
    $.__views.newmessage.add($.__views.__alloyId192);
    ...
    $.__views.__alloyId198 = Ti.UI.createTextField(function() {
        var o = {};
    ...
    $.__views.__alloyId199 = Ti.UI.createTextField(function() {
        var o = {};
        Alloy.deepExtend(true, o, {
            top: "67%",
            left: "25%",
    ...
    $.__views.__alloyId192.add($.__views.__alloyId201);
    ...
    $.__views.__alloyId192.add($.__views.__alloyId202);
    $.__views.__alloyId203 = Ti.UI.createTextArea(function() {
        var o = {};
        Alloy.deepExtend(true, o, {
            font: {
                fontSize: 14
    ...
    $.__views.newmessage.add($.__views.__alloyId203);
