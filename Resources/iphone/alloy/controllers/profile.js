...
function Controller() {
    ...
    $.__views.__alloyId225.add($.__views.__alloyId234);
    ...
    $.__views.__alloyId236 = Ti.UI.createTextField(function() {
        var o = {};
    ...
    $.__views.__alloyId239.add($.__views.profileImage);
    ...
    $.__views.__alloyId239.add($.__views.name);
    ...
    $.__views.__alloyId239.add($.__views.job);
    ...
    $.__views.__alloyId239.add($.__views.company);
    ...
    $.__views.__alloyId239.add($.__views.addFavoriteBtn);
    ...
    $.__views.__alloyId240.add($.__views.callBtn);
    $.__views.emailBtn = Ti.UI.createLabel({
        id: "emailBtn"
    });
    $.__views.__alloyId240.add($.__views.emailBtn);
    $.__views.msgBtn = Ti.UI.createLabel({
        id: "msgBtn"
    });
    $.__views.__alloyId240.add($.__views.msgBtn);
    ...
    $.__views.__alloyId241.add($.__views.fbBtn);
    $.__views.liBtn = Ti.UI.createLabel({
        id: "liBtn"
    });
    $.__views.__alloyId241.add($.__views.liBtn);
    $.__views.googBtn = Ti.UI.createLabel({
        id: "googBtn"
    });
    $.__views.__alloyId241.add($.__views.googBtn);
    ...
    $.__views.contactInfo.add($.__views.__alloyId242);
    ...
    $.__views.contactInfo.add($.__views.__alloyId243);
    ...
    $.__views.__alloyId244.add($.__views.start_date);
    ...
    $.__views.__alloyId243.add($.__views.__alloyId257);
