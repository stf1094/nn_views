...
function Controller() {
    ...
    $.__views.Window_1.add($.__views.__alloyId288);
    var __alloyId289 = [];
    ...
    __alloyId289.push($.__views.__alloyId298);
    ...
    __alloyId289.push($.__views.__alloyId306);
    ...
    $.__views.__alloyId314 = Ti.UI.createTableViewRow({
        layout: "horizontal",
        height: "140px",
        id: "__alloyId314"
    });
    __alloyId289.push($.__views.__alloyId314);
    ...
    $.__views.__alloyId319 = Ti.UI.createView(function() {
        var o = {};
        Alloy.deepExtend(true, o, {
            layout: "horizontal",
            left: "10"
