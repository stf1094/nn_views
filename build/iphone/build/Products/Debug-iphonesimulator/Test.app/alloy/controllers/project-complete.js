...
function Controller() {
    ...
    $.__views.__alloyId258 = Ti.UI.createView(function() {
        var o = {};
    ...
    $.__views.__alloyId262 = Ti.UI.createButton({
        left: "9.78%",
        width: "80%",
        height: "90px",
    ...
    $.__views.__alloyId263 = Ti.UI.createButton({
        top: 10,
        height: "90px",
        left: "10%",
    ...
    $.__views.__alloyId264 = Ti.UI.createImageView(function() {
        var o = {};
        Alloy.deepExtend(true, o, {
            left: "41%",
            top: "1.5%",
